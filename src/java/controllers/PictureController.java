...
public class PictureController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        switch (req.getServletPath()) {
            case "/me/picture":
                ...
                dispatcher = req.getRequestDispatcher("/views/user/picture.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for (Part part : request.getParts()) {
            ...
            fileName = (new Integer((int) request.getSession().getAttribute("user_id"))).toString() + "";
        ...
        request.getRequestDispatcher("/views/user/picture.jsp").forward(request, response);
    }
